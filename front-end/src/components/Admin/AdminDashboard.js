...
export function AdminDashboard({ onClose }) {
  // LẤY TRẠNG THÁI DARK MODE TỪ CONTEXT TOÀN CỤC
  ...
  return (
    // SỬ DỤNG BIẾN isDarkMode TỪ CONTEXT ĐỂ ĐIỀU KHIỂN CLASS CSS
    <div className={`admin-dashboard-layout ${isDarkMode ? "admin-dark-mode" : ""}`}>
