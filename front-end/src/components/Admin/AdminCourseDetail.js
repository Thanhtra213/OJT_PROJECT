...
export default function AdminCourseDetail() {
  ...
  const handleToggleFlashcard = async (setId) => {
    ...
    if (!detailedFCs[setId]) {
      try {
        ...
        else if (Array.isArray(data.vocabularies)) cardsArray = data.vocabularies;
        else if (Array.isArray(data.list)) cardsArray = data.list;
  ...
  if (isLoading) {
    return (
      <div style={{ padding: "2rem", boxSizing: "border-box" }}>
        <div className="admin-loading-spinner" style={{ minHeight: '60vh', maxWidth: "1200px", margin: "0 auto" }}>
  ...
  if (!course) {
    return (
      <div style={{ padding: "2rem", boxSizing: "border-box" }}>
        <div className="management-card" style={{ maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div className="management-card" style={{ padding: "0", overflow: "hidden", borderRadius: "12px", boxShadow: "0 4px 15px rgba(0,0,0,0.05)" }}>
        ...
        <div style={{ padding: "2rem", borderBottom: "1px solid var(--border)", backgroundColor: "var(--bg-light)" }}>
          <button 
            ...
            style={{ 
              marginBottom: "1.5rem", padding: "8px 20px", backgroundColor: "#fff", 
        ...
        <div style={{ padding: "2rem", backgroundColor: "#fff", minHeight: "400px" }}>
          ...
          {activeTab === "chapters" && (
            <div>
              <h3 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "1.5rem", color: "var(--text-dark)", marginTop: 0 }}>Lộ trình giảng dạy & Link Video</h3>
          ...
          {activeTab === "flashcards" && (
            <div>
              <h3 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "1.5rem", color: "var(--text-dark)", marginTop: 0 }}>Kho Flashcard</h3>
              {flashcards.length > 0 ? (
          ...
          {activeTab === "quizzes" && (
            <div>
              <h3 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "1.5rem", color: "var(--text-dark)", marginTop: 0 }}>Bài luyện tập (Quiz)</h3>
              {quizzes.length > 0 ? (
                <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                  {quizzes.map((quiz) => {
                        ...
                        {isExpanded && (
                          <div style={{ borderTop: "1px solid var(--border)", backgroundColor: "var(--bg-light)", padding: "1.5rem" }}>
                            {groupsList.length > 0 ? (
                                          ...
                                          <div key={q.questionId || qIdx}>
                                            ...
                                            <div style={{ display: "flex", flexDirection: "column", gap: "6px", paddingLeft: "10px" }}>
                                              {answersList.map((ans, aIdx) => {
                                                ...
                                                return (
                                                <div key={ans.answerId || aIdx} style={{ 
                              ...
                              <div style={{ padding: "1.5rem", textAlign: "center", backgroundColor: "#fff", borderRadius: "8px", border: "1px dashed #cbd5e1" }}>
